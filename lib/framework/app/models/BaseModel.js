...
class BaseModel {
    ...
    async create(obj) {
        try {
            ...
            this.logger.info('BaseModel save' + '<|>table:' + this.model + '<|>item:' + item.id)
    ...
    async update(values, clause) {
        ...
        try {
            ...
            this.logger.info('BaseModel update' + '<|>table:' + this.model + '<|>item:' + item)
            return item
        }catch (err) {
            this.logger.error(err)
        }
    ...
    async delete(clause) {
        try {
            ...
            this.logger.info('BaseModel delete' + '<|>table:' + this.model + '<|>item:' + item)
        }catch (err) {
            this.logger.error(err)
        }
    }
