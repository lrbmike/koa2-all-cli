...
class HttpHelper {
    ...
    async postParseHttpResult (requestUrl, formData, mode, referrer, ttpUrl, cookie, encoding) {
        ...
        myLog4js.info('HttpHelper postParseHttpResult' + '<|>requestUrl:' + requestUrl + '<|>formData:' + JSON.stringify(formData))
